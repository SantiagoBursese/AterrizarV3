...
public class Bienvenida extends javax.swing.JFrame {
    ...
    public Bienvenida(){
        ...
        crearController();
        initComponents();
        nombreUsuario.setText(controler.nombreUsuario());
        this.setVisible(true);
        this.setLocation(500, 200);
        botonAsientos.addActionListener(e -> verAsientos());
        botonReservas.addActionListener(e -> verReservas());
        botonCompra.addActionListener(e -> verCompras());
    ...
    public static void main(String args[]) {
    	...
    	private void crearController() throws AsientoReservadoException, DniInvalidoException {
		controler = new controladorBienvenida();
                DataDummy dummy = new DataDummy();
		controler.setUsuario(dummy.nuevoUsuario());
	}
